 ...
 */
class Version20180429021526 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        switch ($this->connection->getDatabasePlatform()->getName()) {
            case "sqlite":
                ...
                $this->addSql('DROP INDEX UNIQ_6DC044C58C4A1AAC');
                $this->addSql('CREATE TEMPORARY TABLE __temp__group AS SELECT id, estate FROM "group"');
                $this->addSql('DROP TABLE "group"');
                $this->addSql('CREATE TABLE "group" (id VARCHAR(255) NOT NULL, estate CHAR(36) DEFAULT NULL COLLATE BINARY --(DC2Type:guid)
                , PRIMARY KEY(id), CONSTRAINT FK_6DC044C58C4A1AAC FOREIGN KEY (estate) REFERENCES estate (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6DC044C5BF396750 FOREIGN KEY (id) REFERENCES actor (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
                $this->addSql('INSERT INTO "group" (id, estate) SELECT id, estate FROM __temp__group');
                $this->addSql('DROP TABLE __temp__group');
                $this->addSql('CREATE UNIQUE INDEX UNIQ_6DC044C58C4A1AAC ON "group" (estate)');
                $this->addSql('DROP INDEX IDX_86FFD2857597D3FE');
                $this->addSql('DROP INDEX IDX_86FFD285FE54D947');
                $this->addSql('CREATE TEMPORARY TABLE __temp__membership AS SELECT group_id, member_id, ctime FROM membership');
                $this->addSql('DROP TABLE membership');
                $this->addSql('CREATE TABLE membership (group_id VARCHAR(255) NOT NULL COLLATE BINARY, member_id VARCHAR(255) NOT NULL COLLATE BINARY, ctime DATETIME DEFAULT NULL, PRIMARY KEY(group_id, member_id), CONSTRAINT FK_86FFD285FE54D947 FOREIGN KEY (group_id) REFERENCES "group" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_86FFD2857597D3FE FOREIGN KEY (member_id) REFERENCES actor (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
                $this->addSql('INSERT INTO membership (group_id, member_id, ctime) SELECT group_id, member_id, ctime FROM __temp__membership');
                ...
                , posted_by_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, posting_user_id VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, message CLOB NOT NULL COLLATE BINARY, et_order INTEGER NOT NULL, ctime DATETIME NOT NULL, markup_language VARCHAR(255) DEFAULT \'plaintext\' NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_5A8A6C8DE2904019 FOREIGN KEY (thread_id) REFERENCES thread (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5A8A6C8D4105D5C7 FOREIGN KEY (posting_user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5A8A6C8D5A6D2235 FOREIGN KEY (posted_by_id) REFERENCES actor (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
                ...
                $this->addSql('CREATE INDEX IDX_5A8A6C8D4105D5C7 ON post (posting_user_id)');
                $this->addSql('DROP INDEX IDX_31204C8329CCBAD0');
                $this->addSql('UPDATE post SET posting_user_id = posted_by_id');
                ...
                break;
            case "mysql":
                $this->addSql('ALTER TABLE `grant` DROP FOREIGN KEY FK_C905664CA76ED395');
                $this->addSql('ALTER TABLE `grant` ADD CONSTRAINT FK_C905664CA76ED395 FOREIGN KEY (user_id) REFERENCES actor (id)');
                $this->addSql('ALTER TABLE post DROP FOREIGN KEY FK_5A8A6C8D5A6D2235');
                $this->addSql('ALTER TABLE post ADD posting_user_id VARCHAR(255) DEFAULT NULL');
                $this->addSql('UPDATE post SET posting_user_id = posted_by_id');
                $this->addSql('ALTER TABLE post ADD CONSTRAINT FK_5A8A6C8D4105D5C7 FOREIGN KEY (posting_user_id) REFERENCES user (id)');
                $this->addSql('ALTER TABLE post ADD CONSTRAINT FK_5A8A6C8D5A6D2235 FOREIGN KEY (posted_by_id) REFERENCES actor (id)');
                $this->addSql('CREATE INDEX IDX_5A8A6C8D4105D5C7 ON post (posting_user_id)');
                break;
            default:
    ...
    public function down(Schema $schema)
    {
        switch ($this->connection->getDatabasePlatform()->getName()) {
            case "sqlite":
                ...
                $this->addSql('CREATE TEMPORARY TABLE __temp__group AS SELECT id, estate FROM "group"');
                $this->addSql('DROP TABLE "group"');
                $this->addSql('CREATE TABLE "group" (id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:guid)
                , estate CHAR(36) DEFAULT NULL --(DC2Type:guid)
                , PRIMARY KEY(id))');
                $this->addSql('INSERT INTO "group" (id, estate) SELECT id, estate FROM __temp__group');
                $this->addSql('DROP TABLE __temp__group');
                $this->addSql('CREATE UNIQUE INDEX UNIQ_6DC044C58C4A1AAC ON "group" (estate)');
                ...
                $this->addSql('CREATE INDEX IDX_E04992AA900733ED ON permission (estate_id)');
                $this->addSql('DROP INDEX IDX_5A8A6C8DE2904019');
                $this->addSql('DROP INDEX IDX_5A8A6C8D4105D5C7');
                $this->addSql('DROP INDEX IDX_5A8A6C8D5A6D2235');
                $this->addSql('CREATE TEMPORARY TABLE __temp__post AS SELECT id, thread_id, posted_by_id, title, message, et_order, ctime, markup_language FROM post');
                $this->addSql('DROP TABLE post');
            ...
            case "mysql":
                ...
                $this->addSql('ALTER TABLE post DROP FOREIGN KEY FK_5A8A6C8D4105D5C7');
                $this->addSql('ALTER TABLE post DROP FOREIGN KEY FK_5A8A6C8D5A6D2235');
                $this->addSql('DROP INDEX IDX_5A8A6C8D4105D5C7 ON post');
                $this->addSql('ALTER TABLE post DROP posting_user_id');
