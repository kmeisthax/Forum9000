 ...
 */
class Version20180418051645 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        switch ($this->connection->getDatabasePlatform()->getName()) {
            case "sqlite":
                ...
                break;
            case "mysql":
                $this->addSql('ALTER TABLE post ADD markup_language VARCHAR(255) DEFAULT \'plaintext\' NOT NULL');
                break;
            default:
    ...
    public function down(Schema $schema)
    {
        switch ($this->connection->getDatabasePlatform()->getName()) {
            case "sqlite":
                ...
                break;
            case "mysql":
                $this->addSql('ALTER TABLE post DROP markup_language');
                break;
            default:
                $this->abortIf(true, 'Migration can only be executed safely on \'sqlite\' or \'mysql\'.');
                break;
