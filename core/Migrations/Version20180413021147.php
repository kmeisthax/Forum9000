 ...
 */
class Version20180413021147 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        switch ($this->connection->getDatabasePlatform()->getName()) {
            case "sqlite":
                ...
                $this->addSql('CREATE TEMPORARY TABLE __temp__forum AS SELECT id, parent_id, title, description FROM forum');
                ...
                , title VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, slug VARCHAR(255) NOT NULL, "order" INTEGER DEFAULT 0 NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_852BBECD727ACA70 FOREIGN KEY (parent_id) REFERENCES forum (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
                $this->addSql('INSERT INTO forum (id, parent_id, title, description) SELECT id, parent_id, title, description FROM __temp__forum');
                ...
                , user_id VARCHAR(255) NOT NULL COLLATE BINARY, attribute VARCHAR(255) NOT NULL COLLATE BINARY, is_granted BOOLEAN NOT NULL, is_denied BOOLEAN NOT NULL, PRIMARY KEY(attribute, forum_id, user_id), CONSTRAINT FK_C905664C29CCBAD0 FOREIGN KEY (forum_id) REFERENCES forum (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C905664CA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
                $this->addSql('INSERT INTO grant (forum_id, user_id, attribute, is_granted, is_denied) SELECT forum_id, user_id, attribute, is_granted, is_denied FROM __temp__grant');
                ...
                $this->addSql('INSERT INTO permission (forum_id, attribute, is_granted_auth, is_granted_anon, is_denied_auth, is_denied_anon) SELECT forum_id, attribute, is_granted_auth, is_granted_anon, is_denied_auth, is_denied_anon FROM __temp__permission');
                ...
                $this->addSql('CREATE TEMPORARY TABLE __temp__thread AS SELECT id, forum_id, is_locked FROM thread');
                ...
                $this->addSql('INSERT INTO thread (id, forum_id, is_locked) SELECT id, forum_id, is_locked FROM __temp__thread');
                $this->addSql('DROP TABLE __temp__thread');
                $this->addSql('CREATE INDEX IDX_31204C8329CCBAD0 ON thread (forum_id)');
                break;
            case "mysql":
                $this->addSql('ALTER TABLE forum ADD slug VARCHAR(255) NOT NULL, ADD `order` INT DEFAULT 0 NOT NULL');
                $this->addSql('CREATE UNIQUE INDEX UNIQ_852BBECD989D9B62 ON forum (slug)');
                $this->addSql('ALTER TABLE thread ADD `order` INT DEFAULT 0 NOT NULL');
                break;
            default:
    ...
    public function down(Schema $schema)
    {
        switch ($this->connection->getDatabasePlatform()->getName()) {
            case "sqlite":
                ...
                $this->addSql('CREATE INDEX IDX_C905664CA76ED395 ON "grant" (user_id)');
                $this->addSql('DROP INDEX IDX_E04992AA29CCBAD0');
                $this->addSql('CREATE TEMPORARY TABLE __temp__permission AS SELECT attribute, forum_id, is_granted_auth, is_granted_anon, is_denied_auth, is_denied_anon FROM permission');
                $this->addSql('DROP TABLE permission');
                $this->addSql('CREATE TABLE permission (attribute VARCHAR(255) NOT NULL, forum_id CHAR(36) NOT NULL --(DC2Type:guid)
                , is_granted_auth BOOLEAN DEFAULT \'0\' NOT NULL, is_granted_anon BOOLEAN DEFAULT \'0\' NOT NULL, is_denied_auth BOOLEAN DEFAULT \'0\' NOT NULL, is_denied_anon BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(attribute, forum_id))');
                $this->addSql('INSERT INTO permission (attribute, forum_id, is_granted_auth, is_granted_anon, is_denied_auth, is_denied_anon) SELECT attribute, forum_id, is_granted_auth, is_granted_anon, is_denied_auth, is_denied_anon FROM __temp__permission');
                $this->addSql('DROP TABLE __temp__permission');
                $this->addSql('CREATE INDEX IDX_E04992AA29CCBAD0 ON permission (forum_id)');
                $this->addSql('DROP INDEX IDX_5A8A6C8DE2904019');
                $this->addSql('DROP INDEX IDX_5A8A6C8D5A6D2235');
                ...
                , is_locked BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(id))');
                $this->addSql('INSERT INTO thread (id, forum_id, is_locked) SELECT id, forum_id, is_locked FROM __temp__thread');
                $this->addSql('DROP TABLE __temp__thread');
                $this->addSql('CREATE INDEX IDX_31204C8329CCBAD0 ON thread (forum_id)');
                break;
            case "mysql":
                ...
                $this->addSql('ALTER TABLE forum DROP slug, DROP `order`');
                $this->addSql('ALTER TABLE thread DROP `order`');
                break;
            default:
                $this->abortIf(true, 'Migration can only be executed safely on \'sqlite\' or \'mysql\'.');
                break;
